...
function ColumnPanel:constructor(parent, kind, rows, gap, x, y, width, height, text)
  super(self).constructor(self, parent, x, y, width, height)
...
function uiextension.ColumnPanel(parent, kind, rows, gap, x, y, width, height, text)
  return ColumnPanel(parent, kind, rows, gap, x, y, width, height, text)
end
